...
<body>
        ...
        <div class="container p-0 ">
            ...
            <div class="row mt-1 ">
                            ...
                            <div class="card jingga p-0">
                                ...
                                <div class="row no-gutters pb-1 border-bottom">
                                    <div class="col-sm-4 gambar">
                                        <a href="<?=base_url("news/detail/$row->slug") ?>"><img class="w-100 h-100" src="<?=base_url("images/content/$row->image") ?>" alt="" srcset=""></a>
                                    </div>
                ...
                <div class="col-sm-3 p-0 pr-3 sidebar-sticky pt-1 hilang">
